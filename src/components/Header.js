...
export default function Header() {
			...
			<div class="row ">
				...
				<div class="col-md-9 col-sm-9 text-right d-flex align-items-center">
					<div class="collapse nav navbar-collapse" id="navbar-collapse">
					  <ul class="mainmenu ">
						<li class=""><a href="https://www.facebook.com/" class="">Services <i class="fa fa-angle-down" aria-hidden="true"></i></a>
							<div class="submenu">
								<div class="container">
								  <div class="row">
									<div class="col-md-3">
						...
						<li class=""><a href="https://www.facebook.com/" class="">Industries <i class="fa fa-angle-down" aria-hidden="true"></i> </a>
							<div class="submenu">
								<div class="container">
								  <div class="row">
									<div class="col-md-3">
						...
						<li class="insightdrop"><a href="https://www.facebook.com/" class="">Insights <i class="fa fa-angle-down" aria-hidden="true"></i> </a>
							<div class="submenu">
								<div class="container">
								  <div class="row">
									<div class="col-md-3">
						...
						<li class="getlink"><a href="https://www.facebook.com/" class="" data-toggle="modal" data-target="#get_trained">Get Started</a></li>
					  </ul>
					</div>
				  </div>
			</div>
 ...
 <span> AI </span> Is here </h1>
					<p><a href="https://www.facebook.com/" class="" data-toggle="modal" data-target="#get_trained">Get In Touch</a> </p>
				{/* </div> */}
			</div>
		</div>
